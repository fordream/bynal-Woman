...
//		builder.show();
		...
		new ComfirmMessageDialog(context, message, listener, null, R.string.ok_dialog, 0).show();
	}
...
//		builder.show();
		...
		new ComfirmMessageDialog(context, message, onClickListener, onClickListener2, R.string.ok_dialog, R.string.cancel_dialog).show();
	}
